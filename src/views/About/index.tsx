    ...
    <main>
        ...
        <div className='container'>
          <div className='row'>
            <div className='col-lg-6 align-self-center'>
              ...
              <h2 className='font-heading mb-50'>
      ...
      <section className='pt-65 pb-65 position-relative'>
        <div className='container'>
          ...
          <h2 className='font-heading mb-50'>Our Mission</h2>
        ...
        <div className='container'>
          <div className='row mb-20'>
            <div className='col-lg-8'>
              ...
              <h2 className='font-heading mb-50'>Our Values</h2>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit ut
                aliquam, purus sit amet luctus venenatis, lectus magna fringilla
                urna, porttitor rhoncus dolor purus non enim praesent elementum
              ...
              <div className='value-box'>
                ...
                <div className='value-content'>
                  ...
                  <p className='font-md'>
                    ...
                    Illum optio quis volup tatum quaerat ratione nisi inventore
                    voluptate molestias
                  </p>
                </div>
              </div>
              ...
              <div className='value-box'>
                ...
                <div className='value-content'>
                  ...
                  <p className='font-md'>
                    ...
                    Illum optio quis volupt atum quaerat ratione nisi inventore
                    voluptate molestias
                  </p>
                </div>
              </div>
          ...
          <div className='row'>
            <div className='col-lg-3 col-md-6 mb-30'>
              ...
              <p className='font-sm'>
                ...
                fuga esse quibusdam dolor veritatis similique sin
              </p>
            </div>
